...
Console.WriteLine("\tПоставщики, которые поставляют товары только дороже 10000 (синтаксис 2):\n");
...
IEnumerable<Item> filteredItems2 = items
			 .Where(i => i.ProductionDate.Year != DateTime.Now.Year || i.Price < even8_2);
...
Console.WriteLine("\tВывести полные наименования товаров в виде {Артикул} {Наименование} {Цвет} (синтаксис 2):\n");
...
//вывести поставщиков, поставляющих самые дорогие товары